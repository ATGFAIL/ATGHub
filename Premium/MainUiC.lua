...
-- Language system is embedded at the bottom of this file
-- ============================================================
local Lang

local function BootMainUI()
...
do
    ...
    local j = true
    local k = Lang:T("common.loading") or "ATG HUB"
...
end -- BootMainUI wrapper

---------------------------------------------------------------------
-- Embedded Language System (auto-translator + caching)
---------------------------------------------------------------------
local function BuildLanguageSystem()
    ...
    LanguageSystem.cacheExpiry = 3600
    LanguageSystem.requestTimeout = 10
